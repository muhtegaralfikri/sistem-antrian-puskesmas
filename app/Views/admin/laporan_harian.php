    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-blue-900 text-white">
            ...
            <nav class="mt-4">
                ...
                <a href="/admin/laporan/harian" class="block py-2 px-4 bg-blue-800">Laporan</a>
            ...
            <form method="get" class="bg-white rounded-lg shadow p-4 mb-6">
                <div class="flex gap-4 items-end">
                    <div>
                        ...
                        <input type="date" name="tanggal" value="<?= esc($tanggal) ?>" class="border rounded px-3 py-2">
                    </div>
                    <div>
                    ...
                    <a href="/admin/laporan/harian" class="text-gray-600 hover:text-gray-800 px-4 py-2">
                        Reset
                    </a>
                    <a href="/admin/laporan/export/harian?tanggal=<?= esc($tanggal) ?>&poli_id=<?= esc($poli_id) ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">
                        Export CSV
                    </a>
                </div>
            </form>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Panggil</th>
                        ...
                        <?php else: ?>
                            <?php foreach ($antrian as $i => $a): ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm"><?= $a['waktu_panggil'] ? date('H:i', strtotime($a['waktu_panggil'])) : '-' ?></td>
