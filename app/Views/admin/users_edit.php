            ...
            <form action="/admin/users/edit/<?= $user['id'] ?>" method="post">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="col-span-1 md:col-span-2 pt-2">
                        <div class="p-4 bg-gray-50 rounded-xl border border-gray-200/60" x-data="{ showPassword: false }">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Password Baru (Opsional)</label>
                            <div class="relative">
                                <input :type="showPassword ? 'text' : 'password'" name="password" 
                                       class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-100 focus:border-primary-500 transition-all outline-none bg-white pr-12" 
                            ...
                            <p class="text-xs text-gray-500 mt-2">Minimal 6 karakter. Biarkan kosong jika tidak ingin mengubah.</p>
                        </div>
                    </div>
