    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6">
            <div class="max-w-2xl mx-auto">
                ...
                <form action="/admin/users/edit/<?= $user['id'] ?>" method="post" class="bg-white rounded-lg shadow p-6">
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2">Username</label>
                        <input type="text" name="username" value="<?= old('username', $user['username']) ?>" required class="w-full border rounded-lg px-3 py-2" minlength="3" maxlength="50">
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2">Password (kosongkan jika tidak diubah)</label>
                        <input type="password" name="password" class="w-full border rounded-lg px-3 py-2" minlength="6" placeholder="Biarkan kosong untuk tidak mengubah">
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2">Nama Lengkap</label>
                        <input type="text" name="nama_lengkap" value="<?= old('nama_lengkap', $user['nama_lengkap']) ?>" required class="w-full border rounded-lg px-3 py-2" minlength="2" maxlength="100">
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="aktif" value="1" <?= old('aktif', $user['aktif']) ? 'checked' : '' ?> class="mr-2">
                            <span>Aktif</span>
                        </label>
                    </div>
