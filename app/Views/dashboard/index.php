...
<div x-data="dashboardApp()" class="min-h-screen bg-gray-50">
    <!-- Loading -->
    <div x-show="loading" class="fixed inset-0 bg-gray-100 z-50 flex items-center justify-center">
            ...
            <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500" x-text="'Halo, ' + user.nama_lengkap"></p>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800" x-text="stats.total_waiting || 0"></p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800" x-text="stats.total_serving || 0"></p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800" x-text="stats.total_completed || 0"></p>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
                        ...
                        <div class="bg-gradient-to-r from-primary-600 to-primary-700 px-5 py-4 flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-primary-200 text-sm" x-text="'Kode: ' + poli.poli.prefix"></p>
                            </div>
                            ...
                            <div x-show="poli.current" class="flex items-center justify-between">
                                ...
                                <div class="flex gap-2">
                                    <button @click="recall(poli.poli.id, poli.current.id)" :disabled="loading"
                                            class="action-btn bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-2 rounded-lg font-medium text-sm flex items-center gap-1 disabled:bg-gray-300">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button @click="selesai(poli.poli.id, poli.current.id)" :disabled="loading"
                                            class="action-btn bg-green-500 hover:bg-green-600 text-white px-3 py-2 rounded-lg font-medium text-sm flex items-center gap-1 disabled:bg-gray-300">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                        </svg>
                                        Done
                        ...
                        <div class="p-5">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <button @click="panggilBerikutnya(poli.poli.id)" :disabled="loading || poli.waiting_count === 0"
                                        class="action-btn bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg font-medium text-sm flex items-center gap-1 disabled:bg-gray-300">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
